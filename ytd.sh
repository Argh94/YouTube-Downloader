...
command='--no-mtime -o /storage/emulated/0/Pictures/YouTubeVideos/%(title)s.%(ext)s --restrict-filenames --retry-sleep 15 --retries 5 --force-ipv4 --merge-output-format mp4'
