...
# Install Python, wget, coreutils, ffmpeg, and termux-api
echo -e "\e[033mInstalling Python, wget, coreutils, ffmpeg, and termux-api...\n$kill_color"
pkg install python wget coreutils ffmpeg termux-api -y
